...
public final class ObjectTypeInfoHelper {
    ...
    private static final int OBJECT_TYPE_VERSION = 30;
    ...
    public static ObjectTypeInfo getObjectTypeInfo() {
        ...
        Collections.addAll(objectTypeList, User.class, Visit.class, Museum.class, Artifact.class, LinkedAccount.class);

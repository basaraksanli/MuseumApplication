...
class SharedAuthViewModel(application: Application) : AndroidViewModel(application) {
    ...
    companion object {
         ...
         */
        @BindingAdapter("mContext")
        @JvmStatic
        fun checkGoogleAvailability(view: View, mContext: Context) {
         ...
         */
        @BindingAdapter("facebookButtonPermissions")
        @JvmStatic
        fun facebookButtonPermissions(view: LoginButton, any: Any?) {
            view.setPermissions("email", "public_profile")
        }

...
public class SiteListAdapter extends RecyclerView.Adapter<SiteListAdapter.SiteViewHolder> {
    ...
    public void onBindViewHolder(@NonNull SiteViewHolder holder, int position) {
        ...
        holder.setData(clickedSite , mContext , root);
 //       setAnimation(holder.itemView, position);
    ...
    static class SiteViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(Site data, Context context, View root) {
            ...
            imageView.setOnClickListener(v -> {
                ...
                bottomSheetView.findViewById(R.id.favorite_button).setOnClickListener(v12 -> {
                    FavoriteMuseum temp=UserLoggedIn.Companion.getInstance().getMuseumFavorite(context,data.getName());
                    if(temp==null) {
                ...
                if(UserLoggedIn.Companion.getInstance().getMuseumFavorite(context,data.getName())!=null)
                    ((ImageView)bottomSheetView.findViewById(R.id.starImage)).setColorFilter(context.getResources().getColor(R.color.color_gold), PorterDuff.Mode.SRC_IN);
    ...
    public SiteListAdapter(List<Site> data, @NonNull Context context, View root) {
        dataSet = data;
